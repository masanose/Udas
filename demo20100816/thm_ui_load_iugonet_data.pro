...
;       
        ...
        ;===== Moved param2Text here to escape error =====;
...
pro thm_ui_load_iugonet_data,tabid,loadedData,historyWin,statusBar,treeCopyPtr,timeRangeObj,callSequence,loadTree=loadTree,timeWidget=timeWidget
  ...
  instrumentArray = ['gmag_index','gmag_fluxgate','superdarn','EAR','MF_radar','meteor_radar','MU','BLR']
  ...
  typeArray[4] = ptr_new(['RISH','NIPR'])
  typeArray[5] = ptr_new(['thermo_wind'])
  typeArray[6] = ptr_new(['trop_std','meso_std','iono_std','mw_spc'])
  typeArray[7] = ptr_new(['blr_wind','blr_pwr','blr_spec_width'])
...
;  
  ...
  paramArray[3] = ptr_new(ptrarr(13))
  ...
  (*paramArray[3])[3] = ptr_new(['er_sw_beam1','er_sw_beam2','er_sw_beam3','er_sw_beam4','er_sw_beam5'])
  (*paramArray[3])[4] = ptr_new(['er_pn_beam1','er_pn_beam2','er_pn_beam3','er_pn_beam4','er_pn_beam5'])
  (*paramArray[3])[5] = ptr_new(['efr_dpl_beam1','efr_dpl_beam2','efr_dpl_beam3','efr_dpl_beam4','efr_dpl_beam5'])
  (*paramArray[3])[6] = ptr_new(['efr_pwr_beam1','efr_pwr_beam2','efr_pwr_beam3','efr_pwr_beam4','efr_pwr_beam5'])
  (*paramArray[3])[7] = ptr_new(['efr_sw_beam1','efr_sw_beam2','efr_sw_beam3','efr_sw_beam4','efr_sw_beam5'])
  (*paramArray[3])[8] = ptr_new(['efr_pn_beam1','efr_pn_beam2','efr_pn_beam3','efr_pn_beam4','efr_pn_beam5'])
  (*paramArray[3])[9] = ptr_new(['fr_dpl_beam1','fr_dpl_beam2','fr_dpl_beam3','fr_dpl_beam4','fr_dpl_beam5'])
  (*paramArray[3])[10] = ptr_new(['fr_pwr_beam1','fr_pwr_beam2','fr_pwr_beam3','fr_pwr_beam4','fr_pwr_beam5'])
  (*paramArray[3])[11] = ptr_new(['fr_sw_beam1','fr_sw_beam2','fr_sw_beam3','fr_sw_beam4','fr_sw_beam5'])
  (*paramArray[3])[12] = ptr_new(['fr_pn_beam1','fr_pn_beam2','fr_pn_beam3','fr_pn_beam4','fr_pn_beam5'])
  (*paramArray[4])[0] = ptr_new(['pameungpeuk','pontianak'])                              
  (*paramArray[4])[1] = ptr_new(['syo'])                              
  (*paramArray[5])[0] = ptr_new(['kototabang','serpong'])
  (*paramArray[6])[0] = ptr_new(['trop_wind','trop_pwr','trop_spec_width'])
  (*paramArray[6])[1] = ptr_new(['meso_wind','meso_pwr','meso_spec_width'])
  (*paramArray[6])[2] = ptr_new(['iono_dpl','iono_pwr','iono_spec_width','iono_pn'])
  (*paramArray[6])[3] = ptr_new(['thermo_wind'])
  (*paramArray[7])[0] = ptr_new(['kototabang','serpong','shigaraki'])
  (*paramArray[7])[1] = ptr_new(['kototabang','serpong','shigaraki'])
  (*paramArray[7])[2] = ptr_new(['kototabang','serpong','shigaraki'])
  ...
  (*param2Array[3])[0] = ptr_new(['zonal','meridional','vertical','beam1', $
                                  'beam2','beam3','beam4','beam5'])
  (*param2Array[3])[1] = ptr_new(['faieb4p4','faieb4p4a','faieb4p4b','faieb4p2c','faieb4p2d','faieb2p1a'])
  (*param2Array[3])[2] = ptr_new(['faieb4p4','faieb4p4a','faieb4p4b','faieb4p2c','faieb4p2d','faieb2p1a'])
  (*param2Array[3])[3] = ptr_new(['faieb4p4','faieb4p4a','faieb4p4b','faieb4p2c','faieb4p2d','faieb2p1a'])
  (*param2Array[3])[4] = ptr_new(['faieb4p4','faieb4p4a','faieb4p4b','faieb4p2c','faieb4p2d','faieb2p1a'])
  (*param2Array[3])[5] = ptr_new(['faiefb1p16','faiefb1p16a','faiefb1p16b'])
  (*param2Array[3])[6] = ptr_new(['faiefb1p16','faiefb1p16a','faiefb1p16b'])
  (*param2Array[3])[7] = ptr_new(['faiefb1p16','faiefb1p16a','faiefb1p16b'])
  (*param2Array[3])[8] = ptr_new(['faiefb1p16','faiefb1p16a','faiefb1p16b'])
  (*param2Array[3])[9] = ptr_new(['faifb1p16a','faifb1p16b','faifb1p16c','faifb1p16d','faifb1p16e','faifb1p16f','faifb1p16g','faifb1p16h','faifb1p16i'])
  (*param2Array[3])[10] = ptr_new(['faifb1p16a','faifb1p16b','faifb1p16c','faifb1p16d','faifb1p16e','faifb1p16f','faifb1p16g','faifb1p16h','faifb1p16i'])
  (*param2Array[3])[11] = ptr_new(['faifb1p16a','faifb1p16b','faifb1p16c','faifb1p16d','faifb1p16e','faifb1p16f','faifb1p16g','faifb1p16h','faifb1p16i'])
  (*param2Array[3])[12] = ptr_new(['faifb1p16a','faifb1p16b','faifb1p16c','faifb1p16d','faifb1p16e','faifb1p16f','faifb1p16g','faifb1p16h','faifb1p16i'])
  (*param2Array[4])[0] = ptr_new(['zonal','meridional','vertical'])                              
  (*param2Array[4])[1] = ptr_new(['zonal','meridional'])                              
  (*param2Array[5])[0] = ptr_new(['zonal_wind','meridional_wind','zonal_thermal_speed','meridional_thermal_speed','meteor_num'])
  (*param2Array[6])[0] = ptr_new(['zonal','meridional','vertical','beam1', $
                                  'beam2','beam3','beam4','beam5'])
  (*param2Array[6])[1] = ptr_new(['zonal','meridional','vertical','beam1', $
                                  'beam2','beam3','beam4','beam5'])
  (*param2Array[6])[2] = ptr_new(['beam1','beam2','beam3','beam4','beam5'])
  (*param2Array[6])[3] = ptr_new(['zonal_wind','meridional_wind','vertical_wind','zonal_thermal_speed','meridional_thermal_speed','meteor_num'])
  (*param2Array[7])[0] = ptr_new(['zonal_wind','meridional_wind','vertical_wind'])
  (*param2Array[7])[1] = ptr_new(['pwr_beam1','pwr_beam2','pwr_beam3','pwr_beam4','pwr_beam5'])
  (*param2Array[7])[2] = ptr_new(['sw_beam1','sw_beam2','sw_beam3','sw_beam4','sw_beam5'])

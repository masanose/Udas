 ...
 ; NotesLabel = widget_label(clearDataBase,value='* in collaboration with ERG-SC')
  ...
  instrumentArray = ['Automatic_Weather_Station','Boundary_Layer_Radar','EISCAT_radar',$
		     'Equatorial_Atmosphere_Radar','geomagnetic_field_fluxgate','geomagnetic_field_index',$
                     ...
                     'SuperDARN#','Wind_Profiler_Radar_(LQ-7)']
...
;  
  ...
  (*paramArray[12])[0] = ptr_new(['*(all)','hok','sye','sys'])
 ...
 ; (*param2Array[3])[3] = ptr_new(['*','pc3_onw'])
  ...
  (*param2Array[7])[0] = ptr_new(['*','2.00','3.00','4.00','5.00','6.00','7.00','8.00','9.00','10.00','11.00','12.00','13.00','14.00','15.00','16.00','17.00','18.00']) 
  ...
  (*param2Array[12])[0] = ptr_new(['*','azim_no','pwr','pwr_err','spec_width','spec_width_err','vlos','vlos_err',$

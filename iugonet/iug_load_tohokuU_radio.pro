;+
;Procedure: IUG_LOAD_TOHOKUU_RADIO,
;  IUG_LOAD_TOHOKUU_RADIO, site = site, datatype = datatype, $
...
;
;Example:
;  IUG_LOAD_TOHOKUU_RADIO,  trange = ['2007-01-22/00:00:00','2007-01-24/00:00:00']
;
;Code:
...
;***** Main Procedure *****
;**************************
pro iug_load_tohokuU_radio, site=site, datatype = datatype, $
                           trange = trange, verbose = verbose, $
                           addmaster=addmaster, downloadonly = downloadonly

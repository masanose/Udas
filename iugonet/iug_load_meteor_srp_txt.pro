...
;
;Purpose:
;  Queries the Kyoto_RISH renkei2 servers for the ASCII data of the meteo redar 
;  at the serpong site and loads data into tplot format.
;
;Syntax:
; iug_load_meteor_srp_txt [ ,DATATYPE = string ]
;                         [ ,PARAMETERS = string]
;                         [ ,TRANGE = [min,max] ]
...
pro iug_load_meteor_srp_txt, datatype=datatype, parameters = parameters, trange=trange, verbose=verbose

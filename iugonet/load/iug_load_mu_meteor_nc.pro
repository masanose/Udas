...
;
;SYNTAX:
; iug_load_mu_meteor_nc, datatype = datatype, parameter = parameter, downloadonly = downloadonly, $
...
pro iug_load_mu_meteor_nc, datatype = datatype, parameter = parameter, $
...
;data directory:
;***************
site_data_dir = strsplit('h1km_t60min00/ h1km_t60min30/ h2km_t60min00/ h2km_t60min30/',' ', /extract)
site_data_lastmane = strsplit('.h1t60min00.nc .h1t60min30.nc .h2t60min00.nc .h2t60min30.nc',' ', /extract)
...
kk=0
  ...
  ;The parameter search:'
    for jjj=0, n_elements(site_data_lastmane)-1 do begin
       if parameters[iii] eq 'h1t60min00' then kk=0
       if parameters[iii] eq 'h1t60min30' then kk=1
       if parameters[iii] eq 'h2t60min00' then kk=2
       if parameters[iii] eq 'h2t60min30' then kk=3
    endfor
    ...
    ;===============================
       ...
       source.local_data_dir =  root_data_dir() + 'iugonet/rish/misc/sgk/mu/meteor/nc/1_day/'+site_data_dir[kk]

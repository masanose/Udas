...
;
;NAME:
;iug_load_cosmic_rish
;
;PURPOSE:
;  Queries the Kyoto_RISH servers for the GPS-RO COSMIC FSI data in the netCDF format
...
pro iug_load_cosmic_rish, min_lat = min_lat, $
  max_lat = max_lat, $

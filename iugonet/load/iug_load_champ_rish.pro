...
pro iug_load_champ_rish, min_lat = min_lat, $
  ...
  if ~size(fns,/type) then begin
    ...
    source.local_data_dir = root_data_dir() + 'iugonet/rish/champ/fsi/v2_0/'
    source.remote_data_dir = 'http://database.rish.kyoto-u.ac.jp/arch/iugonet/data/GPS/champ/fsi/v2_0/nc/'

...
; To plot data from Iitate planetary radio observatory, libraries for fits files must be installed into your computer (fits_read, sxpar, fits_open, fits_close, gettok, sxdelpar, sxaddpar, and valid_num) in addition to  the udas and tdas.  They are available at http://idlastro.gsfc.nasa.gov/fitsio.html.
;
;
;Initialize 
thm_init 

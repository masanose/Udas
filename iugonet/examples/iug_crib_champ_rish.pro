;+
;PROCEDURE: IUG_CRIB_CHAMP_RISH.PRO
;    A sample crib sheet that explains how to use the "iug_load_cosmic_champ.pro"
...
;==============================================================================
tsub_average, 'gps_ro_champ_fsi_ref'
tsub_average, 'gps_ro_champ_fsi_pres'
tsub_average, 'gps_ro_champ_fsi_temp'
tplot, ['gps_ro_champ_fsi_ref-d','gps_ro_champ_fsi_pres-d','gps_ro_champ_fsi_temp-d']

stop

;1-hour running average of refractivity, dry air pressure, and temperature:
;==========================================================================
tsmooth_in_time, 'gps_ro_champ_fsi_ref', 3600
tsmooth_in_time, 'gps_ro_champ_fsi_pres', 3600
tsmooth_in_time, 'gps_ro_champ_fsi_temp', 3600

tplot, ['gps_ro_champ_fsi_ref_smoothed','gps_ro_champ_fsi_pres_smoothed','gps_ro_champ_fsi_temp_smoothed']

stop

; Set up the plot time range of refractivity, dry air pressure, and temperature in the troposphere and stratosphere:
;===================================================================================================================
tlimit, '2005-01-02 00:00:00', '2005-01-03 00:00:00'
tplot

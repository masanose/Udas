...
;****************************************
if ~keyword_set(datatype) then datatype='iono_efr_dpl'
...
if datatype eq 'iono_efr_dpl' then begin
   ...
   if vdcname eq 'efr_dpl_beam3' then vdcnames = '3'
   ...
   if vdcname eq 'efr_pwr_beam3' then vdcnames = '3'
   ...
   if vdcname eq 'efr_sw_beam3' then vdcnames = '3'
   ...
   if vdcname eq 'efr_pn_beam3' then vdcnames = '3'
   if vdcname eq 'efr_pn_beam4' then vdcnames = '4'
   if vdcname eq 'efr_pn_beam5' then vdcnames = '5'
endif
...
if datatype eq 'iono_efr_dpl' then begin 
  ...
  if parameters eq 'efr_pwr_beam1' then begin
    ...
    ;===================================
  if parameters eq 'efr_pwr_beam2' then begin
     dlimit=create_struct('data_att',create_struct('acknowledgment',acknowledgstring))

...
pro iug_load_ear_iono_vr_txt, datatype = datatype, parameter1=parameter1, parameter2=parameter2,$
                              downloadonly=downloadonly, trange=trange, verbose=verbose
  ...
  for iii=0,n_elements(parameters2)-1 do begin
   ...
   ;******************************
      ...
      if time ne 0 then begin
         ...
         options,'iug_ear_fai_'+parameters[ii]+'_'+parameters2[iii], labels='EAR-FAI V-region [km]'
         ; add options

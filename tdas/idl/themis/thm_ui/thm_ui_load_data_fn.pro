...
;                   parameters
;$LastChangedBy: jwl $
;$LastChangedDate: 2009-01-09 11:53:47 -0800 (Fri, 09 Jan 2009) $
;$LastChangedRevision: 4388 $
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/thm_ui/thm_ui_load_data_fn.pro $
;
;-
Function thm_ui_load_data_fn, st_time0, en_time0, $
  ...
  If(st_time Lt ttest0 Or st_time Gt ttest1 Or $
    ...
    message, /info, 'Invalid Time Input, No Data Loaded'
    Return, otp
  Endif
  If(en_time Le st_time) Then Begin
    If(obj_valid(progobj)) Then $
      progobj -> update, 0.0, text = 'Start time LT end time, No Data Loaded'
    message, /info, 'Start time LT end time,  No Data Loaded'
    Return, otp
  Endif

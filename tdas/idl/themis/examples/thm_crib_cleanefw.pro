...
;
; ***WARNING: Running THM_CRIB_EFI (or likely just calling THM_LOAD_EFI) after this crib will result in the wrong plot labels).
;             The problem is probably in the way that some of the LASP code handles, or does not handle, the labelling.
  ;.r defthmconst.crib   ; load often-used constants
  ;window, 0, xs=960, ys=770, xpos=1920

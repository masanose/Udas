...
;$LastChangedDate: 2008-05-15 10:47:18 -0700 (Thu, 15 May 2008) $
;$LastChangedRevision: 3093 $
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/common/thm_file_cleanup.pro $
;
...
If(ndelf Gt 0) Then Begin
  ...
  if keyword_set(print) then begin
    ...
    for i = 0, n_elements(info)-1 do $
      print,i, time_string(info[i].atime, /local), $
  ...
  Endif
Endif Else print, 'No Old files to delete'

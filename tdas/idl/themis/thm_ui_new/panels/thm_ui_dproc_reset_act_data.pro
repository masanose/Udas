...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/thm_ui_new/panels/thm_ui_dproc_reset_act_data.pro $
;-

Pro thm_ui_dproc_reset_act_data, dproc_id, update_tree = update_tree
...
;create names with times in single strings for display
    ...
    Endif
  Endif Else Begin
    message, /info, 'Invalid Data Object'

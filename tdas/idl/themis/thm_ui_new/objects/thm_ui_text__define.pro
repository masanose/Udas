...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/thm_ui_new/objects/thm_ui_text__define.pro $
;-----------------------------------------------------------------------------------



FUNCTION THM_UI_TEXT::Copy
   out = Obj_New('THM_UI_TEXT')
...
;Mainly uses thm_ui_getset setProperty method, just handles special case for color
PRO THM_UI_TEXT::SetProperty,color=color, _extra=ex
...
FUNCTION THM_UI_TEXT::GetFormats
formats = [             $
        'Bold',         $
        'Italic',       $
        'Bold*Italic',  $
...
FUNCTION THM_UI_TEXT::GetFormat, Index=index
...
FUNCTION THM_UI_TEXT::GetFormatIndex, FormatName=formatname
...
FUNCTION THM_UI_TEXT::GetFont, Index=index
IF N_Elements(index) EQ 0 THEN index = self.font
IF NOT Is_Numeric(index) THEN RETURN, -1
IF index LT 0 OR index GT 12 THEN RETURN, -1
fonts = self->GetFonts()
RETURN, fonts(index)
END ;--------------------------------------------------------------------------------
...
FUNCTION THM_UI_TEXT::GetFontIndex, FontName=fontname
...
FUNCTION THM_UI_TEXT::getGrFont
...
FUNCTION THM_UI_TEXT::Init,         $ ; The INIT method of the line style object
...
PRO THM_UI_TEXT__DEFINE
   ...
   struct = { THM_UI_TEXT,            $
              ...
              INHERITS thm_ui_readwrite,  $ ; use generalize read/write methods

...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/thm_ui_new/objects/thm_ui_time_range__define.pro $
;-----------------------------------------------------------------------------------



FUNCTION THM_UI_TIME_RANGE::Copy
   out=Obj_New("THM_UI_TIME_RANGE")
   newStart=Obj_New("THM_UI_TIME")
   newEnd=Obj_New("THM_UI_TIME")
...
FUNCTION THM_UI_TIME_RANGE::GetStartTime, String=string
...
FUNCTION THM_UI_TIME_RANGE::GetEndTime, String=string
...
FUNCTION THM_UI_TIME_RANGE::GetDuration
...
FUNCTION THM_UI_TIME_RANGE::SetStartTime, starttime
...
FUNCTION THM_UI_TIME_RANGE::SetEndTime, endtime
...
FUNCTION THM_UI_TIME_RANGE::Init, $
   ...
   CASE startType OF
      ...
      0:  starttime = Obj_New("THM_UI_TIME") 
      ;   double precision
      5:  starttime = Obj_New("THM_UI_TIME", TDouble=starttime) 
      ;   string
      7:  starttime = Obj_New("THM_UI_TIME", TString=starttime)
      ;   object - don't need to do anything
   ...
   CASE endType OF
      ;   undefined - set to default time object 
      0:  endtime = Obj_New("THM_UI_TIME") 
      ;   double precision
      5:  endtime = Obj_New("THM_UI_TIME", TDouble=endtime) 
      ;   string
      7:  endtime = Obj_New("THM_UI_TIME", TString=endtime)
      ;   object - don't need to do anything
      11: endtime = endtime
      ;   if not one of the above types - something went wrong
     ELSE: RETURN, 0
...
PRO THM_UI_TIME_RANGE__DEFINE

   struct = { THM_UI_TIME_RANGE,   $

      startTime : Obj_New(),   $ ; start time 
      endTime : Obj_New(),      $ ; end time
      inherits thm_ui_getset $  ;general purpose getProperty/setProperty/getAll/setAll methods

...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/thm_ui_new/objects/thm_ui_window_menus__define.pro $
;-

PRO THM_UI_WINDOW_MENUS::Add, name
...
PRO THM_UI_WINDOW_MENUS::Remove, name
...
FUNCTION THM_UI_WINDOW_MENUS::GetIds
  RETURN, *self.ids
END ;--------------------------------------------------------------------------------



FUNCTION THM_UI_WINDOW_MENUS::GetNames
  RETURN, *self.names
END ;--------------------------------------------------------------------------------



PRO THM_UI_WINDOW_MENUS::Clear
...
PRO THM_UI_WINDOW_MENUS::Update, windowStorage
    self->Clear
    IF Ptr_Valid(self.names) THEN BEGIN
       numNames=N_Elements(*self.names)
       menuNames=*self.names
...
PRO THM_UI_WINDOW_MENUS::Cleanup
Ptr_Free, self.names
Ptr_Free, self.ids
END ;--------------------------------------------------------------------------------
...
FUNCTION THM_UI_WINDOW_MENUS::Init,   $
...
PRO THM_UI_WINDOW_MENUS__DEFINE

   struct = { THM_UI_WINDOW_MENUS,$

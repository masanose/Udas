...
;$LastChangedDate: 2009-08-31 17:04:00 -0700 (Mon, 31 Aug 2009) $
;$LastChangedRevision: 6662 $
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/thm_ui_new/objects/thm_ui_data_group__define.pro $
;-


pro thm_ui_data_group::addDataObject,object
...
pro thm_ui_data_group::add,name,object,active=active
...
function thm_ui_data_group::remove,name,nodelete=nodelete
...
function thm_ui_data_group::removeAll,nodelete=nodelete
...
function thm_ui_data_group::hasChild,name
...
function thm_ui_data_group::hasActive,name
...
pro thm_ui_data_group::setActive,name,clear=clear
...
pro thm_ui_data_group::clearActive,name
...
pro thm_ui_data_group::clearAllActive
...
function thm_ui_data_group::getActiveChildren
...
function thm_ui_data_group::getChildren
...
function thm_ui_data_group::getTimeObject
...
function thm_ui_data_group::getDataObjects
...
function thm_ui_data_group::getObject,name
...
function thm_ui_data_group::getAllObjects
...
function thm_ui_data_group::getActive
...
function thm_ui_data_group::getName
...
pro thm_ui_data_group::setName,name
...
function thm_ui_data_group::getDataNames
...
pro thm_ui_data_group::setDataNames,names
...
pro thm_ui_data_group::setTimeName,name
...
function thm_ui_data_Group::getTimeName
...
function thm_ui_data_group::getYAxisParent
...
pro thm_ui_data_group::setYAxisParent,name
...
function thm_ui_data_group::getYaxisName
...
pro thm_ui_data_group::setYAxisName,name
...
pro thm_ui_data_group::setisYaxis

  self.isyaxis = 1

end

pro thm_ui_data_group::setnotYaxis

  self.isyaxis = 0
  
end

function thm_ui_data_group::getIsYaxis

  return,self.isyaxis

end

function thm_ui_data_group::getIndepName
...
pro thm_ui_data_group::setIndepName,name
...
function thm_ui_data_group::getSize
...
function thm_ui_data_group::getNdims
...
function thm_ui_data_group::getDim1
...
function thm_ui_data_group::getTimeRange
...
function thm_ui_data_group::init,name=name,active=active
...
pro thm_ui_data_group__define

  struct = { THM_UI_DATA_GROUP, $
               dataNames: ptr_new(),$
               dataActive: ptr_new(),$
               dataObjs: ptr_new(),$
               active:0, $

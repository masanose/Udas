...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/thm_ui_new/objects/thm_ui_lock_axes__define.pro $
;
;--------------------------------------------------------------------------------

;Call this to lock axes in the current window
pro thm_ui_lock_axes::lock,windowId=windowid
...
pro thm_ui_lock_axes::unlock,windowId=windowId
...
pro thm_ui_lock_axes::add,panel
...
pro thm_ui_lock_axes::remove,panel
...
pro thm_ui_lock_axes::panel_change,panel,remove=remove
...
pro thm_ui_lock_axes::lock_middle,panel,range,unlock=unlock
...
pro thm_ui_lock_axes::lock_top,panel,range,unlock=unlock
...
pro thm_ui_lock_axes::lock_bottom,panel,range,unlock=unlock
...
function thm_ui_lock_axes::get_range,col,panels
...
pro thm_ui_lock_axes::update,unlock=unlock,windowId=windowId
...
function thm_ui_lock_axes::init,window_storage,draw_object,loaded_data
...
pro thm_ui_lock_axes__define

  compile_opt idl2

  struct = { thm_ui_lock_axes,     $

...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/thm_ui_new/objects/thm_ui_time__define.pro $
;-----------------------------------------------------------------------------------



FUNCTION THM_UI_TIME::Copy
   out = Obj_New("THM_UI_TIME")
...
PRO THM_UI_TIME::UpdateStructure
...
PRO THM_UI_TIME::SetProperty,            $ ; standard set property method
...
FUNCTION THM_UI_TIME::GetStructure  
  RETURN, Time_Struct(self.tDouble)
END ;--------------------------------------------------------------------------------



FUNCTION THM_UI_TIME::IsValid, TString=tstring, TDouble=tdouble 
...
FUNCTION THM_UI_TIME::GetAll
  RETURN, self
END ;--------------------------------------------------------------------------------



PRO THM_UI_TIME::GetProperty,            $
              TDouble=tdouble,           $ ; double precision time (sec. since 1970)
              TString=tstring,           $ ; time string YYYY/MM/DD-hh:mm:ss.ss
              TEpoch=tepoch,             $ ; epoch time (double precision - for CDF)
              Year=year,                 $ ; year 
...
;FUNCTION THM_UI_DATA::Cleanup 
;   nothing to clean (yet...)
;END ;--------------------------------------------------------------------------------



FUNCTION THM_UI_TIME::Init,             $ ; The INIT method of the bar object.
              TDouble=tdouble,          $ ; double precision time (sec. since 1970)
              TString=tstring,          $ ; time string YYYY/MM/DD-hh:mm:ss.ss

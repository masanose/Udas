...
pro saveas_ascii,loadedData=loadedData,field_names=field_names,timefmt=timefmt,fmt_strings=fmt_strings,fmt_code=fmt_code,sepstring=sepstring,filename=filename,flagstring=flagstring,statuscode=statuscode,statusmsg=statusmsg,hdrfmt=hdrfmt,timeflag=timeflag,timerange=timerange,yaxisflag=yaxisflag
;print,flagstring,format='("flagstring: ",A)'
;print,field_names,format='("field_names: ",A)'
;print,timefmt,format='("timefmt: ",I)'
;print,sepstring,format='("sepstring: ->",A,"<-")'
;print,filename,format='("filename: ",A)'
;print,timeflag,format='("timeflag: ",I)'
;print,timerange[0],timerange[1],format='("Start: ",F20.6," End: ",F20.6)'

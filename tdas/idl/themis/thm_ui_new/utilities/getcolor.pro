...
IF StrUpCase(thisColor) EQ 'LIGHTGREY' THEN theColor = 'LIGHTGRAY'
IF StrUpCase(thisColor) EQ 'MEDIUMGREY' THEN theColor = 'MEDIUMGRAY'
IF StrUpCase(thisColor) EQ 'SLATEGREY' THEN theColor = 'SLATEGRAY'
IF StrUpCase(thisColor) EQ 'DARKGREY' THEN theColor = 'DARKGRAY'
IF StrUpCase(thisColor) EQ 'SKY' THEN theColor = 'SKYBLUE'
IF StrUpCase(thisColor) EQ 'NAVY BLUE' THEN theColor = 'NAVY'
IF StrUpCase(thisColor) EQ 'NAVYBLUE' THEN theColor = 'NAVY'

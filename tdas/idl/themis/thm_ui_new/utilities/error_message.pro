...
;
; Copyright � 1999-2003 Fanning Software Consulting
;
...
defsysv,'!GUIDEBUG',exists=debugexists

IF (~debugexists || !GUIDEBUG eq 0) && widgetsSupported THEN BEGIN
   ...
   IF !ERROR_STATE.NAME EQ "IDL_M_USER_ERR" THEN BEGIN
      ...
      IF Keyword_Set(noname) THEN BEGIN
          ; need to add the call to error panel here

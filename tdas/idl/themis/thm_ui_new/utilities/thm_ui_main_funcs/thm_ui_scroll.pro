 pro thm_ui_scroll_update_panel,panelObj,drawObject,direction,index
...
PRO thm_ui_scroll, windowStorage, drawObject, direction
      ...
      IF Obj_Valid(panels) THEN BEGIN
         ...
         IF NOT Is_Num(panelObjs) THEN BEGIN
            ...
            if locked ge 0 && locked lt n_elements(panelObjs) then begin
              ...
              thm_ui_scroll_update_panel,panelObjs[locked],drawObject,direction,locked
            
            endif else begin
              ; for each panel get it info from the draw object and
              ; update the range     
              FOR i=0, N_Elements(panelObjs)-1 DO BEGIN
                thm_ui_scroll_update_panel,panelObjs[i],drawObject,direction,i             
              ENDFOR
            endelse
         ENDIF
      ENDIF

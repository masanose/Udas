...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/thm_ui_new/utilities/thm_ui_main_funcs/thm_ui_scrollb.pro $
;-

pro thm_ui_scrollb,info
  ...
  ENDIF ELSE BEGIN
    thm_ui_scroll, info.windowStorage, info.drawObject, 1

...
; $LastChangedDate: 2007-06-28 17:58:19 -0700 (Thu, 28 Jun 2007) $
; $LastChangedRevision: 938 $
; $URL $
;-
...
case strupcase( rate) of
	...
	'8K':	r = 1
		...
		message, /info, string( rate, format='("invalid rate string,",A)')
...
case nbins of
	...
	64:	b = 2
		...
		message, /info, string( nbins, format='("invalid nbins value,",I)')
		cent_freq = !values.f_nan
		return
	end
endcase

...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/spacecraft/fields/spin_tones_cleaning_vector_v5.pro $
;-
...
print,'nbpts_wind =',nbpts_wind

nbpts_cl =  nbwind*nbpts_wind
print,'nbpts_cl(=nbwind*nbpts_wind)= ',nbpts_cl
If(nbpts_cl Eq 0) Then Begin ;short batches will return NaN, jmm, 9-feb-2009
  message, /info,' warning: No points, returning 1 NaN value'
  ...
  Return
Endif
if (nbpts_cl ne nbpts) then print,'warning: the cleaned waveform will be shorter than the raw waveform'

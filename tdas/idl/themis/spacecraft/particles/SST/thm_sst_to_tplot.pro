pro thm_sst_to_tplot,probes=probes
...
for p=0,n_elements(probes)-1 do begin
    ...
    if ptr_valid(data.sif_064_time) then begin
       ...
       store_data,name+'_ang',data={x:time , y:y ,  v:findgen(64) }, dlimit={spec:1,zlog:1 ,no_interp:1, zrange:[1,2e4], ystyle:1}
       y = total(thm_part_decomp16(*data.sif_064_data,nan=nan),3)
       store_data,name+'_en',data={x:time , y:y ,  v:findgen(16) }, dlimit={spec:1,zlog:1 ,no_interp:1, zrange:[1,1e5], ystyle:1}
;       y = total(y[*,
;       store_data,name_'_rate',data={x:time, y:y }
       y = total(y[*,0:11],2)
       store_data,name+'_tot',data={x:time , y:y  }, dlimit={ylog:1 , yrange:[1,1e6], ystyle:1}
       store_data,name+'_cnfg',data={x:time , y:*data.sif_064_cnfg  }, dlimit={ tplot_routine:'bitplot'}
       store_data,name+'_nspn',data={x:time , y:*data.sif_064_nspins  }, dlimit={ tplot_routine:'bitplot'}
       store_data,name+'_atten',data={x:time , y:*data.sif_064_atten  }, dlimit={ tplot_routine:'bitplot'}
    ...
    if ptr_valid(data.sir_001_time) then begin
       ...
       store_data,name+'_en',data={x:time , y:y ,  v:findgen(16) }, dlimit={spec:1,zlog:1 ,no_interp:1, zrange:[1,1e5]}
       y = total(y[*,0:11],2)
       store_data,name+'_tot',data={x:time , y:y }, dlimit={ylog:1 , yrange:[1,1e6], ystyle:1}
       dprint,dlevel=2,name
    endif
    if ptr_valid(data.sir_006_time)  then begin
       ...
       store_data,name+'_ang',data={x:time , y:y ,  v:findgen(6) }, dlimit={spec:1,zlog:1 ,no_interp:1, zrange:[1,2e4], ystyle:1}
       y = total(thm_part_decomp16(*data.sir_006_data,nan=nan),3)
       store_data,name+'_en',data={x:time , y:y ,  v:findgen(16) }, dlimit={spec:1,zlog:1 ,no_interp:1, zrange:[1,1e5], ystyle:1}
       y = total(y[*,0:11],2)
       store_data,name+'_tot',data={x:time , y:y  }, dlimit={ylog:1 , yrange:[1,1e6], ystyle:1}
       store_data,name+'_cnfg',data={x:time , y:*data.sir_006_cnfg  }, dlimit={ tplot_routine:'bitplot'}
       store_data,name+'_nspn',data={x:time , y:*data.sir_006_nspins  }, dlimit={ tplot_routine:'bitplot'}
       dprint,dlevel=2,name
    endif
    ...
    if ptr_valid(data.ser_006_time)  then begin
       ...
       y = total(y[*,0:11],2)
       store_data,name+'_tot',data={x:time , y:y  }, dlimit={ylog:1 , yrange:[1,1e6], ystyle:1}
       store_data,name+'_cnfg',data={x:time , y:*data.ser_006_cnfg  }, dlimit={ tplot_routine:'bitplot'}
       store_data,name+'_nspn',data={x:time , y:*data.ser_006_nspins  }, dlimit={ tplot_routine:'bitplot'}
       dprint,dlevel=2,name
    endif

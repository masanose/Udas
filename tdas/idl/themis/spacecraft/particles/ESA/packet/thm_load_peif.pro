...
pro thm_load_peif,file=file,sc=sc,themishome=themishome,gap_time=gap_time,suffix=suffix
...
; define mode variables for different modes
	nspins = [3,128,32,128,32,128,32,32,32]				; # of spins between measurements in mode
...
;			printdat,fs
	...
	print,'454 Download time= ',tm2-tm1
...
endwhile
	...
	tm2=systime(1)
	print,'454 Decommutation time=',tm2-tm1
...
; help,ifd_dat,/st
print,'Data loading complete: th'+sc+' peif - apid 454'

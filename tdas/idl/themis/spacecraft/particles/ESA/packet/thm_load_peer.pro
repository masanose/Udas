...
pro thm_load_peer,file=file,sc=sc,themishome=themishome,gap_time=gap_time,suffix=suffix
...
; define mode variables for different modes
	...
	nenergy = [16,32,32,32,32,32]				; # of energies in mode
	nangle = [1,1,6,1,6,1]					; # of angles in mode
	dat_len = nenergy*nangle				; size data arrays
	spin_decode  = [160,96,16,96,16,96]			; # measurements in packet
	case_decode  = [0,1,3,1,3,1]				; datl[16,32,96,192]==>size[0,1,2,3]
	angle_decode = [0,1,2,1,2,1]				; angle mode index
...
;			printdat,fs
	...
	print,'458 Download time= ',tm2-tm1
...
endwhile
	...
	tm2=systime(1)
	print,'458 Decommutation time= ',tm2-tm1
...
; help,erd_dat,/st
print,'Data loading complete: th'+sc+' peer - apid 458'

...
pro thm_load_peir,file=file,sc=sc,themishome=themishome,gap_time=gap_time,suffix=suffix
...
; initialize arrays
	...
	dat_4=bytarr(nmax<100000l,1152) 
	dat_5=bytarr(nmax<100000l,1200) 
...
;			printdat,fs
	...
	print,'455 Download time= ',tm2-tm1
...
endwhile
	...
	tm2=systime(1)
	print,'455 Decommutation time= ',tm2-tm1
...
; help,ird_dat,/st
print,'Data loading complete: th'+sc+' peir - apid 455'

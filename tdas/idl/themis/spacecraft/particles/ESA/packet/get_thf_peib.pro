...
;-
FUNCTION get_thf_peib,time,START=st,EN=en,ADVANCE=adv,RETREAT=ret,index=ind,calib=calib,times=times

common thf_456,get_ind,all_dat
                                                                                
if n_elements(get_ind) eq 0 then begin
	dat = 	{project_name:'THEMIS',valid:0}
	print,' ERROR - thf peib data not loaded'

...
pro thm_load_peib,file=file,sc=sc,themishome=themishome,gap_time=gap_time,suffix=suffix
...
; zero data common
	if sc eq 'a' then begin
		...
		common thf_456,thf_456_ind,thf_456_dat & thf_456_dat=0 & thf_456_ind=-1l
	endif
...
;			printdat,fs
	...
	print,'456 Download time= ',tm2-tm1
...
endwhile
	...
	tm2=systime(1)
	print,'456 Decommutation time=',tm2-tm1
...
; help,ibd_dat,/st
print,'Data loading complete: th'+sc+' peib - apid 456'
...
name1='th'+sc+'_peib_en_counts'+suffix

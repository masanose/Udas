...
;-
FUNCTION get_thd_peef,time,START=st,EN=en,ADVANCE=adv,RETREAT=ret,index=ind,calib=calib,times=times

common thd_457,get_ind,all_dat

if n_elements(get_ind) eq 0 then begin
	dat = 	{project_name:'THEMIS',valid:0}
	print,' ERROR - thd peef data not loaded'
...
dat = 		{project_name:		all_dat.project_name,		$
	...
	bins=intarr(nenergy,nbins)
        If(nenergy Eq 15) Then bins[*] = 1 Else bins(1:nenergy-1, *) = 1 ;jmm, 19-may-2009, in 88x15 mode, the highest energy bin is ok

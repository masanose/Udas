...
; VERSION:
;   $LastChangedBy: hfrey $
;   $LastChangedDate: 2008-02-13 17:42:28 -0800 (Wed, 13 Feb 2008) $
;   $LastChangedRevision: 2372 $
;   $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_5_21/idl/themis/ground/asi_mosaic/thm_gbo_site_list.pro $
;-
...
function thm_gbo_site_list,site_list_in,verbose=verbose
	...
	; hfrey
      ...
      if keyword_set(verbose) then if w(0) eq -1 then print,'C101(thm_gbo_site_list): site_list not valid'
return,w
end
;--------------------------------------------------------------------------------------

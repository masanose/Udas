...
;
; $LastChangedBy: jimm $
; $LastChangedDate: 2009-10-13 12:50:58 -0700 (Tue, 13 Oct 2009) $
; $LastChangedRevision: 6849 $
; $URL $
;-
...
thm_init
dprint,verbose=verbose,dlevel=4,'$Id: thm_load_state3.pro 6849 2009-10-13 19:50:58Z jimm $'
...
;     if vb ge 4 then printdat,/pgmtrace,relpathnames
     ...
     options,/default,tns,code_id='$Id: thm_load_state3.pro 6849 2009-10-13 19:50:58Z jimm $'

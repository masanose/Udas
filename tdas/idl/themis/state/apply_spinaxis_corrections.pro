...
pro apply_oneaxis_correction,rawvar=rawvar,deltavar=deltavar,corrvar=corrvar
   ...
   if (raw_n NE 0) then begin
      if (delta_n NE 0) then begin
        ...
        ;message,/info,'Applying corrections'
     ...
     message,/info,'Spin axis corrections variable '+deltavar+' not found, skipping '+corrvar
   endelse
endif else begin
   ; Raw variable doesn't exist, nothing to do here.
   ;message,/info,'Spin axis variable '+rawvar+' not found, skipping '+corrvar
endelse

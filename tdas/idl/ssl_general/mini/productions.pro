...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/ssl_general/tags/tdas_5_21/mini/productions.pro $
;-
...
function productions
  ...
  grammar = {type:'grammar',nonterminals:nonterminals,terminals:terminals,operators:operators,start:start,augment:augment,endline:endline,empty:empty_sym,production_list:plist}

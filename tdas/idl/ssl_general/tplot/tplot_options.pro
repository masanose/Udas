...
if size(/type,tplot_opts) ne 8 then str_element,tplot_vars,'options',0,$
	/add_replace
if size(/type,string) eq 7 then str_element,tplot_vars,'options.'+string,value,$
	/add_replace

if size(/type,datanames) eq 7 then $

...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/ssl_general/tags/tdas_5_21/missions/root_data_dir.pro $
;-
...
function root_data_dir,verbose=verbose
  ...
  if keyword_set(last_warning_time) && (systime(1) - last_warning_time) gt 300  then begin           ; Display message only once every 5 minutes
;      beep
      dprint,verbose=verbose,'No Root Data Directory has been defined! Using default: "'+rootdir+'" (Which might change in the future!)'

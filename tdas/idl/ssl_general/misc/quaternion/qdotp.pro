...
; $LastChangedDate: 2007-11-28 19:25:47 -0800 (Wed, 28 Nov 2007) $
; $LastChangedRevision: 2096 $
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/ssl_general/tags/tdas_5_21/misc/quaternion/qdotp.pro $
;-
...
if(size(/n_dim,q1i) ne size(/n_dim,q2i)) then begin
   message,/continue,'Number of dimensions in quaternion q1 and quaternion q2 do not match'
   return,-1
endif
...
if(n_elements(q1i) ne n_elements(q2i)) then begin
   message,/continue,'Number of elements in quaternion q1 and quaternion q2 do not match'
   return,-1
endif

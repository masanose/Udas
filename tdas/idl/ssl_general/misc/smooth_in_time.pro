...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/ssl_general/tags/tdas_5_21/misc/smooth_in_time.pro $
;-
        ...
        if k eq 0 then begin
          ...
          if mem_usage_total gt 100 then begin
            ...
            if keyword_set(interactive_warning) then begin
              ...
              message,/info,'WARNING: Operation will take between ' + strtrim(mem_usage_total,2) + ' MB and ' + strtrim(2*mem_usage_total,2) + ' MB of memory'
            endelse
          endif

...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/ssl_general/tags/tdas_5_21/misc/dydt_spike_test.pro $
;-
...
;adjacent points
  ...
  If(nok Lt 3) Then Begin
    message, /cont, 'Not enough good data'
    return, flag
  Endif
  t_in = t0[ok]
  t_in = t_in-t_in[0]
...
;Degap if not told not to
  If(Not Keyword_set(no_degap)) Then Begin
    ...
    xdegap, dt, margin, t_in, y_in, t, y, iindices = ii, _extra = _extra

...
;
; $LastChangedBy: jwl $
; $LastChangedDate: 2010-02-05 15:51:58 -0800 (Fri, 05 Feb 2010) $
; $LastChangedRevision: 7220 $
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/ssl_general/tags/tdas_5_21/cotrans/special/fac/fac_matrix_make.pro $
;-
...
valid_coords[0] : begin
    ...
    if(dl.data_att.coord_sys ne 'gse' && $
       dl.data_att.coord_sys ne 'gsm') then begin
        message,/continue,' fx requires mag_var_name to be in GSE or GSM to generate a Xgse field aligned coordinate matrix'
        return
    endif
    ...
    if(error_state eq 0) then begin
        message,/continue,' FX  failed to create yz cross product in ' + valid_coords[0]
        return
    endif
...
valid_coords[1] : begin
    ...
    if dl_2.data_att.coord_sys ne 'gei' then begin
        message,/continue,' FX  requires position data to be in gei coordinates to generate Rgeo transformation'
        return
    endif
...
valid_coords[2] : begin
    ...
    if dl_2.data_att.coord_sys ne 'gei' then begin
        message,/continue,' FX  requires position data to be in gei coordinates to generate mRgeo transformation'
        return
    endif
...
valid_coords[3] : begin
    ...
    if dl_2.data_att.coord_sys ne 'gei' then begin
        message,/continue,' FX  requires position data to be in gei coordinates to generate Phigeo transformation'
        return
    endif
...
valid_coords[4] : begin
    ...
    if dl_2.data_att.coord_sys ne 'gei' then begin
        message,/continue,' FX  requires position data to be in gei coordinates to generate mPhigeo transformation'
        return
    endif
...
valid_coords[5]: begin
    ...
    if dl_2.data_att.coord_sys ne 'gei' then begin
        message,/continue,' FX  requires position data to be in gei coordinates to generate Phism transformation'
        return
    endif
    ...
    if(error_state eq 0) then begin
        message,/continue,'FX failed to calculate Phism by z cross product'
        return
    endif
...
valid_coords[6]: begin
    ...
    if dl_2.data_att.coord_sys ne 'gei' then begin
        message,/continue,' FX  requires position data to be in gei coordinates to generate mPhism transformation'
        return
    endif
...
valid_coords[7]: begin
    ...
    if(dl.data_att.coord_sys ne 'gse' && $
       dl.data_att.coord_sys ne 'gsm') then begin
        message,/continue,' fx requires mag_var_name to be in GSE or GSM to generate a Ygsm field aligned coordinate matrix'
        return
    endif

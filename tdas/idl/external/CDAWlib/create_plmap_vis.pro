...
;$Header: /home/cdaweb/dev/control/RCS/create_plmap_vis.pro,v 1.5 2004/11/17 20:59:05 kovalick Exp johnson $
;$Locker: johnson $
;$Revision: 7091 $
	...
	var_size = size(vardat)
	  ...
	  3: begin
		;if (var_size(3) eq num_recs) then dat = vardat(*,*,k) else $
                ; RCJ 04/09/2007  If var is 'novary' then leave it alone

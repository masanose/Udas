...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/idl_socware/tags/tdas_5_21/external/IDL_GEOPACK/trace/ttrace_crib.pro $
;-
...
;input to the t89 model(par value) is the kp index(can be an array of

;kp indices

ttrace2iono,'thc_state_pos_gsm',newname='thc_ifoot_gsm',external_model=$

't89',par=2.0D,/km

ttrace2equator,'thc_state_pos_gsm',newname='thc_efoot_gsm',$

external_model='t89',par=2.0D,/km

;increase the x margin so that you can see the labels on the left

tplot_options, 'xmargin', [15, 5]

tplot,['thc_state_pos_gsm','thc_ifoot_gsm','thc_efoot_gsm'], title = $

'Themis C position & footprints'
...
ttrace2iono,'thc_state_pos',newname='thc_ifoot',external_model='t89',$

par=2.0D,/km,in_coord='geo',out_coord='geo'
...
ttrace2equator,'thc_state_pos',newname='thc_efoot',external_model='t89'$

,par=2.0D,in_coord='gsm',out_coord='gsm'
...
tplotxy,'thc_state_pos',/add,versus='yrz', xtitle = 'Re', ytitle = 'Re',/$

isotropic,title='y vs z, pos and e-foot'

tplotxy,'thc_efoot',versus='yrz',/overplot,linestyle=2,/isotropic

;plot x vs z with x having its maximum on the left

tplotxy,'thc_state_pos',/add,versus='xrz', xtitle = 'Re', ytitle = 'Re',/$

isotropic,title='x vs z, pos and e-foot'
...
ttrace2iono,'trace_data',trace_var_name = 'trace_n', newname=$

'thc_ifoot',external_model='t89',par=2.0D,in_coord='gsm',out_coord=$

'gsm'

ttrace2iono,'trace_data',trace_var_name = 'trace_s', newname=$
...
title = 'fields x vs z',xrange=[-10,-4],yrange=[-6,4]
...
;par must be a 10 element array(or Nx10) so all other values should be
...
time_clip,'thc_state_pos','2008-07-02/12:00:00','2008-07-02/12:30:00',$

newname='pos_clipped'

ttrace2iono,'pos_clipped',newname='thc_ifoot_gsm',external_model=$

't96',par='t96_par',/km

tplot,['pos_clipped','thc_ifoot_gsm'], title = $
...
ttrace2iono,'pos_clipped',newname='thc_ifoot_gsm',external_model='t01',$
...
ttrace2iono,'pos_clipped',newname='thc_ifoot_gsm',external_model='t04s'$
...
ttrace2iono,'thc_state_pos',newname='thc_ifoot_gsm',external_model=$

't96',par='t96_par',/km

tplot,['thc_state_pos','thc_ifoot_gsm'], title = $

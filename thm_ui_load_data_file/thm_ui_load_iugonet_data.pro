...
pro thm_ui_load_iugonet_data,tabid,loadedData,historyWin,statusBar,treeCopyPtr,timeRangeObj,callSequence,loadTree=loadTree,timeWidget=timeWidget
  ...
  instrumentArray = ['Iitate_Planetary_Radio_Telescope','geomagnetic_field_index','geomagnetic_field_fluxgate','superdarn(ERG)','Equatorial_Atomosphere_Radar',$
...
;  
  ...
  (*paramArray[3])[0] = ptr_new(['hok','sye','sys'])
  (*paramArray[4])[0] = ptr_new(['ear_standard'])
  (*paramArray[4])[1] = ptr_new(['eb1p2a','eb1p2b','eb1p2c','eb2p1a','eb3p2a','eb3p2b','eb3p4a','eb3p4b','eb3p4c',$

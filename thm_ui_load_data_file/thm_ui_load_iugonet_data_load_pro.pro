...
pro thm_ui_load_iugonet_data,tabid,loadedData,historyWin,statusBar,treeCopyPtr,timeRangeObj,callSequence,loadTree=loadTree,timeWidget=timeWidget
  ...
  (*paramArray[6])[6] = ptr_new(['spr_zonal_wind','spr_meridional_wind','spr_vertical_wind'])
  (*paramArray[6])[7] = ptr_new(['spr_pwr_beam1','spr_pwr_beam2','spr_pwr_beam3','spr_pwr_beam4','spr_pwr_beam5'])
  (*paramArray[6])[8] = ptr_new(['spr_sw_beam1','spr_sw_beam2','spr_sw_beam3','spr_sw_beam4','spr_sw_beam5']) 

...
;HISTORY:
;$LastChangedBy: jwl $
;$LastChangedDate: 2009-06-16 11:07:08 -0700 (Tue, 16 Jun 2009) $
...
;
;  IUGONET�f�[�^load�p�Ɉꕔ�ǉAB by Y.Tanaka  20/04/2010
;  Modifications:
...
;============================================
;=== thm_ui_call_sequence::addloadiugonet ===
;============================================
  ...
  for i=0,n_elements(calls)-1 do begin
   ...
   ;===============================================
      ...
      thm_ui_overplot, obj_new(),self.loadedData,obj_new(),$
                       probes=st.probes, date=st.date, dur=st.duration, /dont_delete_data, $
    ...
    endelse
     ...
     thm_ui_interpolate,st.result,st.vars,self.loadedData,historyWin,statustext,/noninteractive
     ...
     thm_ui_cotrans_new,st.value[0],st.active,self.loadedData,statustext,/silent
